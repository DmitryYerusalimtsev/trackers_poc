...
if __name__ == "__main__":
    ...
    # Run this only once on startup
    url = "https://drive.google.com/u/4/uc?id=1QAxtjwAe_lcRM75DeAlaUaQkGmcn2sNE"
    gdown.download(url)

    with zipfile.ZipFile('./pretrained_models.zip', 'r') as zip_ref:
        zip_ref.extractall('./')
